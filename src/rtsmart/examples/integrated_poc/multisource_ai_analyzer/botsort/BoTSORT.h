...
public:
    ...
    explicit BoTSORT(bool reid_enabled=true,float track_high_thresh=0.6,float track_low_thresh=0.1,float new_track_thresh=0.7,long track_buffer=30,float match_thresh=0.7,float proximity_thresh=0.5,float appearance_thresh=0.25,long frame_rate=30,float lambda=0.985);
...
private:
    ...
    long _track_buffer, _frame_rate, _buffer_size, _max_time_lost;
