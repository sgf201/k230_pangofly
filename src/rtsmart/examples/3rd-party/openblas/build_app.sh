#!/bin/bash
# Build and package K230 OpenBLAS examples (incremental build)
# Function: Use CMake and cross-compile toolchain to build all openblas examples and collect them
