...
# Function: Use CMake and cross-compile toolchain to build botsort_track example and collect ELF and utility files
...
# =======================
collect_outputs() {
    local elf_file="${BUILD_DIR}/bin/botsort_track.elf"
