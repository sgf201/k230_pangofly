...
# Function: Use CMake and cross-compile toolchain to build bytetrack_track example and collect ELF and utility files
...
# =======================
collect_outputs() {
    local elf_file="${BUILD_DIR}/bin/bytetrack_track.elf"
