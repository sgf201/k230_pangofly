#!/bin/bash
# Build and package K230 yolo program (incremental build)
# Function: Use CMake and cross-compile toolchain to build yolo example and collect ELF and utility files
...
# =======================
collect_outputs() {
    local elf_file="${BUILD_DIR}/bin/yolo.elf"
