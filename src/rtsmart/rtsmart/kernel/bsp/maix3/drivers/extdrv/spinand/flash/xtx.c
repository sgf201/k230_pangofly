...
int xt26g01c_ecc_get_status(struct aic_spinand *flash, uint8_t status)
{
...
int xt26g02d_ecc_get_status(struct aic_spinand *flash, uint8_t status)
{
...
int xt26g11c_ecc_get_status(struct aic_spinand *flash, uint8_t status)
{
    switch (status & XT26G02D_STATUS_ECC_MASK) {
        case XT26G02D_STATUS_ECC_NO_ERROR:
            return 0;
...
int xt26g01b_ecc_get_status(struct aic_spinand *flash, uint8_t status)
{
    switch (status & XT26G01C_STATUS_ECC_MASK) {
        case XT26G02D_STATUS_ECC_NO_ERROR:
            return 0;
